...
void FOnPawnExitedDoorAreaSignature_DelegateWrapper(const FMulticastScriptDelegate& OnPawnExitedDoorAreaSignature, ALevelDoor* Door, AGridMapRoom* CurrentRoom, AGridMapRoom* NextRoom, APawn* Pawn)
{
	...
	DEFINE_FUNCTION(ALevelDoor::execIsDoorLocked)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->IsDoorLocked();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ALevelDoor::execSetDoorLocked)
	{
		P_GET_UBOOL(Z_Param_bLocked);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetDoorLocked(Z_Param_bLocked);
		P_NATIVE_END;
	}
	...
	void ALevelDoor::StaticRegisterNativesALevelDoor()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "IsDoorLocked", &ALevelDoor::execIsDoorLocked },
			...
			{ "SetDoorLocked", &ALevelDoor::execSetDoorLocked },
		};
	...
	struct Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics
	{
		struct LevelDoor_eventIsDoorLocked_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((LevelDoor_eventIsDoorLocked_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(LevelDoor_eventIsDoorLocked_Parms), &Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/LevelDoor/LevelDoor.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelDoor, nullptr, "IsDoorLocked", nullptr, nullptr, sizeof(Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::LevelDoor_eventIsDoorLocked_Parms), Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ALevelDoor_IsDoorLocked()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ALevelDoor_IsDoorLocked_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics
	{
		struct LevelDoor_eventSetDoorLocked_Parms
		{
			bool bLocked;
		};
	...
	void Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::NewProp_bLocked_SetBit(void* Obj)
	{
		((LevelDoor_eventSetDoorLocked_Parms*)Obj)->bLocked = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::NewProp_bLocked = { "bLocked", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(LevelDoor_eventSetDoorLocked_Parms), &Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::NewProp_bLocked_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::NewProp_bLocked,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/LevelDoor/LevelDoor.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ALevelDoor, nullptr, "SetDoorLocked", nullptr, nullptr, sizeof(Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::LevelDoor_eventSetDoorLocked_Parms), Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ALevelDoor_SetDoorLocked()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ALevelDoor_SetDoorLocked_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bCloseOnTriggerExit_MetaData[];
#endif
		static void NewProp_bCloseOnTriggerExit_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bCloseOnTriggerExit;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_LastDoorUserPawn_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_LastDoorUserPawn;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALevelDoor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ALevelDoor_IsDoorLocked, "IsDoorLocked" }, // 1594060548
		...
		{ &Z_Construct_UFunction_ALevelDoor_SetDoorLocked, "SetDoorLocked" }, // 1819186293
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit_MetaData[] = {
		{ "Category", "LevelDoor" },
		{ "ModuleRelativePath", "Public/LevelDoor/LevelDoor.h" },
	};
#endif
	void Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit_SetBit(void* Obj)
	{
		((ALevelDoor*)Obj)->bCloseOnTriggerExit = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit = { "bCloseOnTriggerExit", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(ALevelDoor), &Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALevelDoor_Statics::NewProp_LastDoorUserPawn_MetaData[] = {
		{ "Category", "LevelDoor" },
		{ "ModuleRelativePath", "Public/LevelDoor/LevelDoor.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALevelDoor_Statics::NewProp_LastDoorUserPawn = { "LastDoorUserPawn", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ALevelDoor, LastDoorUserPawn), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALevelDoor_Statics::NewProp_LastDoorUserPawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelDoor_Statics::NewProp_LastDoorUserPawn_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALevelDoor_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALevelDoor_Statics::NewProp_bCloseOnTriggerExit,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALevelDoor_Statics::NewProp_LastDoorUserPawn,
	...
	struct Z_CompiledInDeferFile_FID_Users_porlo_Documents_MyProject_Plugins_Developer_GridMapEditor_Source_GridMap_Public_LevelDoor_LevelDoor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_porlo_Documents_MyProject_Plugins_Developer_GridMapEditor_Source_GridMap_Public_LevelDoor_LevelDoor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALevelDoor, ALevelDoor::StaticClass, TEXT("ALevelDoor"), &Z_Registration_Info_UClass_ALevelDoor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALevelDoor), 2754021410U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_porlo_Documents_MyProject_Plugins_Developer_GridMapEditor_Source_GridMap_Public_LevelDoor_LevelDoor_h_816624325(TEXT("/Script/GridMap"),
		Z_CompiledInDeferFile_FID_Users_porlo_Documents_MyProject_Plugins_Developer_GridMapEditor_Source_GridMap_Public_LevelDoor_LevelDoor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_porlo_Documents_MyProject_Plugins_Developer_GridMapEditor_Source_GridMap_Public_LevelDoor_LevelDoor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
